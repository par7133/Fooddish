...
<?php endif; ?>
    ...
    <div id="HCsplash" style="padding-top: 40px; text-align:center;color:#ffffff;display:none;">
       <div id="myh1"><H1 style="font-weight:900">DING!</H1></div><br/>
   ...
   <div id="header" class="header" style="margin-top:18px;margin-bottom:18px;display:none;">
        <div style="float:left">
            <a href="/" target="_self" style="color:#000000; text-decoration: none;"><img id="piclogo" src="/res/AFlogo.png" align="middle">&nbsp;<span id="avatarTitle"><?PHP echo(APP_NAME);?></span></a>
        </div>
   </div>
   <div id="headerMob" class="header" style="margin-top:18px;margin-bottom:18px;display:none">
        <div style="float:left">
             <a href="/" target="_self" style="color:#000000; text-decoration: none;"><img id="piclogo" src="/res/AFlogo.png" align="middle">&nbsp;<span id="avatarTitle">DING</span></a>
        </div>   
   </div>
...
<?PHP
   ...
   $pattern = APP_DATA_PATH . DIRECTORY_SEPARATOR . "*" . DIRECTORY_SEPARATOR . "blog" . DIRECTORY_SEPARATOR . "*.jpg";
   $aFiles = glob($pattern);
   $aFiles2 = [];

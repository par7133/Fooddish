...
switch ($url) {
  ...
  case "img":
    ...
    } else if (mb_stripos($pic, "avatar") !== false) {
      $picPath = $AVATARPIC_PATH . DIRECTORY_SEPARATOR . $pic;
    } else {
  ...
  case "qrcode":
    ...
    break;      
  case "{$url2}/friends":
    define("SCRIPT_NAME", "friends");
    define("SCRIPT_FILENAME", "friends.php");   

    define("AVATAR_NAME", $url2);  

...
<?php endif; ?>
   ...
   <div id="header" class="header" style="margin-top:18px;margin-bottom:18px;">
        <div style="float:left">
            <a href="/" target="_self" style="color:#000000; text-decoration: none;"><img id="piclogo" src="/res/AFlogo.png" align="middle">&nbsp;<span id="avatarTitle">DDDD.ING</span></a>
        </div>
   </div>
...
<?PHP     
   ...
   foreach($aFiles2 as $key => $val) {
      $i++;
      $ipos1 = mb_stripos($val, "/friends/");
      $ipos2 = mb_strrpos($val, "/blog/");
      $AVATAR_NAME = substr($val, $ipos1 + 9, ($ipos2 - ($ipos1+9))); 
      $AVATAR_PATH = APP_DATA_PATH . DIRECTORY_SEPARATOR . $AVATAR_NAME;
...
?>
        ...
        <tr>
           <td style="width: 160px;text-transform: uppercase; white-space: nowrap; font-weight:900;border:1px solid #000000;background:<?PHP echo($i%2===0?$background1:$background2);?>">
               <a href="/<?PHP echo($AVATAR_NAME);?>" target="_self" style="color:#000000; text-decoration: none;"><img id="picavatarp" src="/img?av=<?PHP echo($AVATAR_NAME);?>&pic=<?PHP echo($profilePic);?>" align="middle">&nbsp;&nbsp;&nbsp;<span style="position:relative;top:+2px;text-decoration:underline"><?PHP echo($AVATAR_NAME);?></span></a>
           </td>
...
<!-- SKINNER CODE -->
<?php $AVATAR_PATH = APP_DATA_PATH  . DIRECTORY_SEPARATOR . AVATAR_NAME; ?>

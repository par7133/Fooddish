...
<?PHP endif; ?>
  ...
  <meta name="description" content="Welcome to Fooddish! Let everyone have its food."/>
  <meta name="keywords" content="food,fooddish,on,premise,solution,NuMode"/>
...
<?php endif; ?>
   ...
   <div id="header" class="header" style="margin-top:18px;margin-bottom:18px;">
        <div style="float:left">
             <a href="/<?PHP echo(AVATAR_NAME);?>" target="_self" style="color:#000000; text-decoration: none;"><img id="picavatarp" src="/img?av=<?PHP echo(AVATAR_NAME);?>&pic=<?PHP echo($profilePic);?>" align="middle">&nbsp;<span id="avatarTitle"><?PHP echo(strtoupper(AVATAR_NAME));?></span></a>
        </div>
   ...
   <div id="headerMob" class="header" style="margin-top:18px;margin-bottom:18px;display:none">
        <div style="float:left">
             <a href="/<?PHP echo(AVATAR_NAME);?>" target="_self" style="color:#000000; text-decoration: none;"><img id="picavatarp" style="position:relative;top:3px;width:22px;height:22px;" src="/img?av=<?PHP echo(AVATAR_NAME);?>&pic=<?PHP echo($profilePic);?>">&nbsp;<span id="avatarTitle" style="position:relative;top:1px;"><?PHP echo(strtoupper(AVATAR_NAME));?></span></a>
        </div>   
   </div>
      ...
      foreach ($aFilePaths as $filePath) {
        ...
        ?>
                     <?PHP if (in_array($orifileExt, ["png", "jpg", "jpeg", "gif", "webp"])):?>      
                          <div class="blog-content"> 
                           <div class="blog-entry" onclick="selectVideo(<?php echo($iEntry-1);?>);" style="background:url('/img?av=<?PHP echo(AVATAR_NAME);?>&pic=<?PHP echo($orifilename);?>');background-size:100% 100%;background-position:center;">  
                          ...
                          <?PHP 
                              $aLinks[] = "/img?av=" . AVATAR_NAME . "&pic=" . $orifilename; 
                             ?>
                      <?PHP EndIf; ?>
                 <?PHP 
       $totLinks = $iEntry;          
                    ...
                    <div class="modal" tabindex="-1" role="dialog" id="modal<?php echo($iLink);?>" style="z-index:99997;margin-top:10px;">
                      <div class="modal-dialog modal-lg" role="document" style="width:95%;margin-top:0;background-color:#FFFFFF;z-index:99998">
                        <div class="modal-content" style="float:left;top:-10px;width: content-box;max-width:60%;z-index:99999;border:0px solid maroon">
                          ...
                          <img id="image<?PHP echo($iLink);?>" class="image" src="" marti-src="<?php echo($aLink); ?>" style="vertical-align:middle; border:0px solid maroon; border-right:0px solid maroon;background:url('<?php echo($aLink); ?>');background-position:center;background-size:120%;">
